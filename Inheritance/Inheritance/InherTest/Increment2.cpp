...
#include "stdafx.h"
#include <iostream>
#include "Increment2.h" // include definition of class Increment
using namespace std;

// constructor; constant member 'increment' is not initialized 
Increment2::Increment2( int c, int i )
{ 
   count = c; // allowed because count is not constant
   //increment = i; // ERROR: Cannot modify a const object (compile error)
} // end constructor Increment

// print count and increment values
void Increment2::print() const
{
